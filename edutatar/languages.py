...
strings = {
    "ru": {
        ...
        "quarter": "Четверть",
        "marks": "Оценки",
        "delimeter": "Разграничитель",
        "changeDelimeter": 'Кнопками "+" и "-" уменьшайте и увеличивайте размер разграничителя, пока не будет полностью влезать в строку. Это сделано для большего удобства. :)\n',
        "save": "Сохранить",
    },
    "tr": {
